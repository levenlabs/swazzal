...
describe('parse', function() {
  ...
  it('should correctly parse id=foo', function () {
  ...
  it('should correctly parse id=foo;cl=bar', function () {
  ...
  it('should correctly parse id=fo=o', function () {
  ...
  it('should correctly parse id=', function () {
    const rule = parse('id=');
    assert.lengthOf(rule.identifiers, 1);
    assert.equal(rule.identifiers[0].property, 'id');
    assert.equal(rule.identifiers[0].value, '');
  });
